...
const firebaseConfig = {
  apiKey: variables.env.REACT_APP_API_KEY,
  authDomain: variables.env.REACT_APP_AUTH_DOMAIN,
  databaseURL: variables.env.REACT_APP_DATABASE_URL,
  projectId: variables.env.REACT_APP_PROJECT_ID,
  storageBucket: variables.env.REACT_APP_STORAGE_BUCKET,
  messagingSenderId: variables.env.REACT_APP_MESSAGING_SENDER_ID,
}
